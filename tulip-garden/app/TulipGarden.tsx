...
const TOOLS: [string, string][] = [["OrdinalsBot","ordinalsbot.com"],["UniSat","unisat.io/inscribe"],["Gamma","gamma.io/inscribe"],["Ordinals Wallet","ordinalswallet.com"],["OrdDropz","ord-dropz.xyz"],["Trio","trio.xyz"],["Satflow","satflow.com"],["Ordzaar","ordzaar.com"],["Magisat","magisat.io"],["ord.net (coming soon)","ord.net"],["ord CLI","docs.ordinals.com"]];
...
function MarketplacePoll(): React.ReactElement {
  ...
  return (
    <div style={{marginBottom:32}}>
      <div style={{border:"1px solid #39ff1440",padding:"12px 24px",background:"rgba(57,255,20,0.04)",borderRadius:2,textAlign:"center",boxShadow:"0 0 12px rgba(57,255,20,0.08), inset 0 0 8px rgba(57,255,20,0.03)",marginBottom:16,display:"inline-block"}}>
      ...
      <div style={{color:"#1a6a1a",fontSize:11,lineHeight:1.8,marginBottom:16}}>
